...
## 简介
[`YIQ = rgb2ntsc(RGB)`](#function1)

## 用法
<a id="function1"></a>
[YIQ](#P1) = rgb2ntsc[(RGB)](#Q1) 将 RGB 图像的红、绿、蓝值转换为 NTSC 图像的亮度和色度值。
...
### 输出参数
**<a id="P1"></a> YIQ — 转换后的 YIQ 颜色值**  
数值数组

转换后的 YIQ 颜色值，返回与输入大小相同的数值数组。
