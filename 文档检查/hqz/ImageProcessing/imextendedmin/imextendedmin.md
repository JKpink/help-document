...
## 简介
[`BW = imextendedmin(I, H)`](#function1)
[`BW = imextendedmin(I, H, conn)`](#function2)

## 用法
<a id="function1"></a>
[BW](#Q4) = imregionalmin([I](#Q1), [H](#Q2)) 计算图像 `I` 的扩展最小值变换，该变换本质是 H - 最小值变换的区域极小值。区域极小值指像素值恒定的连通分量，且其外部边界像素的取值均高于该分量的像素值。其中 `H` 为非负标量。
<a id="function2"></a>
[BW](#Q4) = imregionalmin([I](#Q1), [H](#Q2), [conn](#Q3)) 计算扩展最小值变换（即 H - 最小值变换的区域极小值），其中 `conn` 参数用于指定像素的连通性。
