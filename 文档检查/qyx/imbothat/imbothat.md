...
## 简介
[`J = imbothat(I, SE)`](#function1)  
[`J = imbothat(I, nhood)`](#function2)

## 用法
<a id="function1"></a>
[J](#Q4) = imbothat([I](#Q1), [SE](#Q2)) 使用结构元素 `SE` 对灰度或二值图像 `I` 执行底帽滤波。  
<a id="function2"></a>
[J](#Q4) = imbothat([I](#Q1), [nhood](#Q3)) 对图像I执行底帽滤波，其中`nhood` 是由指定结构元素邻域的 0 和 1 组成的矩阵。此语法等效于 imbothat (I, strel(nhood))。
...
href="../imtophat/imtophat.html">imtophat</a> 