## xyz2double
将 XYZ 颜色值转换为 double 类型

## 简介
[`xyzD = xyz2double(xyz)`](#function1)

## 用法
<a id="function1"></a>
[xyzD](#P1) = xyz2double([xyz](#Q1)) 将 XYZ 颜色值转换为 `double` 类型。
...
要转换的颜色值，指定为 m×3 数值矩阵（每行一种颜色）或 m×n×3 数值数组。

**数据类型：** `uint16`

### 输出参数
**<a id="P1"></a> xyzD — 转换后的颜色值**  
数值数组
